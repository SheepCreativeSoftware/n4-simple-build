...
describe('#initProjectTestRuntime', function () {
	...
	it('#Folder and files should be created for a runtime module', async function () {
	...
	it('#It should create a runtime specific module meta file', async function () {
	...
	it('#It should create a runtime specific buildConfig file', async function () {
